...
class Festival(models.Model):
    ...
    entradas_platino = models.PositiveIntegerField(default=0,null=True,blank=True)
    entradas_oro = models.PositiveIntegerField(default=0,null=True,blank=True)
    entradas_general = models.PositiveIntegerField(default=0,null=True,blank=True)
