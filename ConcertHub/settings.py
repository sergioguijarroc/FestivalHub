...
SECRET_KEY = os.getenv("SECRET_KEY", "django-insecure-rbxun@ma1)xqfh1gu*lhix6pi8g3@2btf&v%yzr$3&jpm4kh=r")
...
if ENVIRONMENT == 'production':
    ...
    CONN_MAX_AGE = 0  # o configura como se menciona en la documentación de Neon
else:
    DATABASES = {
        'default': {
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, "static/CSS"),  # Agregar esta línea
]
